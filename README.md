...
**Reactlots** is a real estate web application where users can browse and explore properties (lots) from _The Sims 4_ as if they were part of the game world.
...
- [reactlots-api](https://github.com/lairaalmas/reactlots-api) → Static data API (WIP)
...
Check out this project's documentation [here](./app/docs/README.md)
